...
public class SearchMovie extends AsyncTask<String, String, Void> {
    ...
    public SearchMovie(OnMovieSearchDone p) {
        caller=p;
    }
    @Override
    protected Void doInBackground (String... params) {
        String url1 = "https://api.themoviedb.org/3/movie/top_rated?api_key=c9b0bbf7aca75298c8581cbfd53f19d5";
        try {
            ...
            for (int i=0; i<10; i++) {
                ...
                id.add(movie.getString("id"));
            }
            for (int i=0; i<id.size(); i++) {
                url=new URL("https://api.themoviedb.org/3/movie/"+id.get(i)+"?api_key=c9b0bbf7aca75298c8581cbfd53f19d5");
